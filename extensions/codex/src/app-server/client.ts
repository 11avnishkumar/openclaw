...
export const MIN_CODEX_APP_SERVER_VERSION = "0.124.0";
...
function parseVersionForComparison(version: string): { parts: number[]; prerelease: boolean } {
  // Same-version prereleases do not satisfy a stable protocol floor because
  // important app-server contract changes can land between alpha cuts.
